...
def get_dataloaders_label(source_data, target_data, target_data_label,
                          evaluation_data, conf):
    ...
    return get_loader_label(source_data,
                            target_data,
                            target_data_label,
                            evaluation_data,
                            data_transforms,
...
def get_models(kwargs):
    ...
    opt_g = optim.SGD(params,
                      ...
                      weight_decay=0.0005,
                      nesterov=True)
    opt_c = optim.SGD(list(C1.parameters()) + list(C2.parameters()),
                      lr=1.0,
                      momentum=conf.train.sgd_momentum,
                      weight_decay=0.0005,
                      nesterov=True)
...
def get_models_new(kwargs):
    ...
    if kwargs['amp_type'] == 'nvidia':
        print('nvidia apex model iitialization!')
